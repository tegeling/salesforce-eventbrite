...
sfdx force:package:version:create --package "Eventbrite" --path force-app --installationkeybypass --wait 20 --codecoverage --targetdevhubusername devhub

sfdx force:package:version:promote --package Eventbrite@0.1.0-3 --targetdevhubusername devhub
